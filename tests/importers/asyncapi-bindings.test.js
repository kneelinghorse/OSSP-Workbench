...
import { detectProtocolBindings } from '../../packages/runtime/importers/asyncapi/binding-detector.js';
import { extractKafkaBindings } from '../../packages/runtime/importers/asyncapi/kafka-utils.js';
import { extractAMQPBindings } from '../../packages/runtime/importers/asyncapi/amqp-utils.js';
import { extractMQTTBindings } from '../../packages/runtime/importers/asyncapi/mqtt-utils.js';
...
describe('Protocol Binding Detection', () => {
  ...
  test('binding detection completes within performance target (<300ms)', async () => {
    const specPath = path.join(fixturesPath, 'kafka-events.yaml');
