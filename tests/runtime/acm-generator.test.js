...
describe('ACM Generator', () => {
  ...
  describe('Error Handling', () => {
    test('should wrap non-ACM errors', async () => {
      ...
      // Mock an internal method to throw a non-ACM error so the wrapping logic in createACM triggers
      const originalGenerateManifest = generator._generateManifest;
      generator._generateManifest = jest.fn().mockImplementation(() => {
      ...
      generator._generateManifest = originalGenerateManifest;
    });
  });
});
