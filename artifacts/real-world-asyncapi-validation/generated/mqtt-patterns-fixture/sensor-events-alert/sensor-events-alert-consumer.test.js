import { SensorEventsAlertConsumer } from './sensor/events/alert-consumer';

/**
 * Tests for SensorEventsAlertConsumer
 *
 * Test strategy:
 ...
 */
describe('SensorEventsAlertConsumer', () => {
  let consumer;

  beforeEach(() => {
    // Setup consumer with test configuration
    consumer = new SensorEventsAlertConsumer({
