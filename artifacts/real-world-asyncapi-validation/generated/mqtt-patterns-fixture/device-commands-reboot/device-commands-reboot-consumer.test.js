import { DeviceCommandsRebootConsumer } from './device/commands/reboot-consumer';

/**
 * Tests for DeviceCommandsRebootConsumer
 *
 * Test strategy:
 ...
 */
describe('DeviceCommandsRebootConsumer', () => {
  let consumer;

  beforeEach(() => {
    // Setup consumer with test configuration
    consumer = new DeviceCommandsRebootConsumer({
