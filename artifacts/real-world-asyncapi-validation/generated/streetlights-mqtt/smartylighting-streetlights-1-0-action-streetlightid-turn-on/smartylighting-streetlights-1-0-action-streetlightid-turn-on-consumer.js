...
/**
 * MQTT Consumer for smartylighting/streetlights/1/0/action/{streetlightId}/turn/on
 ...
 * - Error topic: smartylighting/streetlights/1/0/action/{streetlightId}/turn/on/errors
...
export class SmartylightingStreetlights10ActionStreetlightIdTurnOnConsumer {
  ...
  constructor(config) {
    ...
    this.clientId = normalizedConfig.clientId || process.env.MQTT_CLIENT_ID || 'smartylighting/streetlights/1/0/action/{streetlightId}/turn/on-consumer-' + Math.random().toString(16).slice(2, 10);
    ...
    this.errorHandling = {
      ...
      errorTopic: normalizedConfig.errorTopic || process.env.MQTT_ERROR_TOPIC || 'smartylighting/streetlights/1/0/action/{streetlightId}/turn/on/errors',
  ...
  async start() {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.client.on('connect', () => {
        ...
        this.client?.subscribe('smartylighting/streetlights/1/0/action/{streetlightId}/turn/on', { qos: this.consumerOptions.qos }, (err) => {
          if (err) {
            if (!settled) {
              settled = true;
              reject(err);
